---
title: 'Review Highlight.js Language Examples'
...
Review existing real-life Highlight.js language examples (e.g., highlightjs-cypher, highlightjs-robots-txt) to understand their structure and implementation.
